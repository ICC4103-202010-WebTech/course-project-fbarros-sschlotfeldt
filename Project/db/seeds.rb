...
u1 = User.create!(userName: "Fcob95", name: "Francisco Barros", bio: "bio1", address: "Address1", email: "fjbarros1@miuandes.cl", password: "123456", admin: false, )
u2 = User.create!(userName: "SSch20", name: "Sebastian Schlotfeldt", bio: "bio2", address: "Address2", email: "sschlotfeldt@miuandes.cl", password: "123456", admin: false)
u3 = User.create!(userName: "Pepito", name: "Pepe Lagos", bio: "bio3", address: "Address3", email: "pepito@gmail.com", password: "123456", admin: false)
u4 = User.create!(userName: "Marco56", name: "Marcos Mayer", bio: "bio4", address: "Address4", email: "marco@gmail.com", password: "123456", admin: false)
u5 = User.create!(userName: "Esteb44", name: "Esteban Soto", bio: "bio5", address: "Address5",  email: "esteban@gmail.com", password: "123456", admin: false)
u6 = User.create!(userName: "Rosa12",  name: "Rosa Vargas", bio: "bio6", address: "Address6", email: "rosa@gmail.com", password: "123456", admin: false)
u7 = User.create!(userName: "Maria2222", name: "Maria Vera", bio: "bio7", address: "Address7", email: "maria@gmail.com", password: "123456", admin: false)
u8 = User.create!(userName: "Trini54", name: "Trini Laso", bio: "bio8", address: "Address8",  email: "trini@gmail.com", password: "123456", admin: false)
u9 = User.create!(userName: "Admin1", name: "Administrator Master", bio: "Im the administrator boss", address: "Address9",  email: "administrator@gmail.com", password: "123456", admin: true)
